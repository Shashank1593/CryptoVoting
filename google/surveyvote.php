...
<body><header id="header">
    ...
    <div class="innerinfo1">
    	...
    	<div class="srvyarea">
            <?php
                ...
                if($qry1rows<=0){
                  $msg24="Sorry,No survey available now";
                  ?>
                <script type='text/javascript'>alert('<?php echo $msg24 ?>');
                window.location='voter_dashboard.php';
                </script>; 
                <?php
               // header("Location:voter_dashboard.php?$_SESSION['email']");
                }
    ...
    if(isset($_POST['submit']))
    {
        ...
        while ($j<$qry1rows) {
           ...
           $srvyqry="SELECT srvyid$quesidar[$j] FROM google WHERE  email='$em'";
           ...
           if($srvyz=='')
           {
            ...
            // update voter table and entrying option 
                $qrysr1="UPDATE google SET srvyid$quesidar[$j]='$option' WHERE email='$em'";
            ...
            {
                $msg13="You Have Alredy Voted";
            ?>
            <script type='text/javascript'>alert('<?php echo $msg13 ?>');
             window.location='voter_dashboard.php';
             </script>
            <?php }
